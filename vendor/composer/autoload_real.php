...
class ComposerAutoloaderInit16a54a02a6ed5bf88fcd66530369f111
{
    ...
    public static function getLoader()
    {
        ...
        $includeFiles = \Composer\Autoload\ComposerStaticInit16a54a02a6ed5bf88fcd66530369f111::$files;
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire16a54a02a6ed5bf88fcd66530369f111($fileIdentifier, $file);
        }
 ...
 * @return void
 */
function composerRequire16a54a02a6ed5bf88fcd66530369f111($fileIdentifier, $file)
{
